...
int main(void) {
	...
	do
	{
		...
		respuestaInt1 = getInt("\nSeleccione una opción del menú (opciones 1 a 6)",3,1,6,"\nError, ingrese número entre 1 y 6\n",&seleccion);
		if(respuestaInt1 == 0)
		{
			printf("\n\nUd. ingresó la opción %d\n",seleccion);
			retorno = 0;
		}
		else
		{
		...
		{
			case 1:
				respuestaFloat1 = getFloat("\nIngrese kilómetros de distancia de su viaje:\n",3,1,999999,"\nError, ingrese número entre 1 y 999999\n",&kmIngresados);
				if(respuestaFloat1 == 0)
				{
					printf("\nUd. ingresó %.2f kilómetros.\n",kmIngresados);
					retorno = 0;
					cargaInicial1 = 0;
				}
				else
			...
			case 2:
				...
				{
					printf("\nUd. ingresó un precio de %.2f por Aerolineas.\n",precioIngresadoAerolineas);
					cargaInicial2 = 0;
				}
				else
				{
				...
				{
					printf("\nUd. ingresó un precio de %.2f por Latam.\n",precioIngresadoLatam);
					cargaInicial3 = 0;
				}
				else
				{
			...
			case 3:
				if(cargaInicial1 == 0 && cargaInicial2 == 0 && cargaInicial3 == 0)
				{
					...
					printf("\nLos costos fueron calculados, ingrese opción 4 para visualizarlos.");
					cargaInicial4 = 0;
				}
				else
				{
					printf("\n\nError: debe cargar la distancia en kilómetros (opción 1) y ambos precios (opción2) para calcular costos.\n");
					printf("\n\t Aguarde para regresar al menú principal.");
					Sleep(3000);
					printf("\n\t3...");
					Sleep(2000);
					printf("\n\t2...");
			...
			case 4:
				...
				{
					printf("\n\nDebe cargar la distancia en kilómetros (opcion 1), ambos precios (opcion 2) y calcular costos (opcion 3) para seleccionar esta opción.\n");
					printf("\n\t Aguarde para regresar al menú principal.");
					Sleep(3000);
					printf("\n\t3...");
					Sleep(2000);
